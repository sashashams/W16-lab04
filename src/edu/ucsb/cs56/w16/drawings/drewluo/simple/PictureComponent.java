package edu.ucsb.cs56.w16.drawings.drewluo.simple;
...
/**
   ...
   @author Andrew Luo(fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
        g2.drawString("Snowman and House by P Conrad and A Luo", 20,20);
