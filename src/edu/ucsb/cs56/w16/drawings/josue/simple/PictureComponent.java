package edu.ucsb.cs56.w16.drawings.josue.simple;
...
/**
   ...
   @author Josue Montenegro (fixed the snowmans's head)
...
{  
	...
	// @@@ 20, 20 are suggested coordinates, but you may change them
         ...
         g2.drawString("A beautiful day in the snow - Josue Montenegro", 20,20);
