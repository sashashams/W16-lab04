package edu.ucsb.cs56.w16.drawings.makhamzadeh.simple;
...
/**
   ...
   @author Matin Akhamzadeh (fixed the snowmans's head)
...
{  
	...
	g2.draw(snowManTopCircle);
        ...
        g2.drawString("My Snowman by Matin Akhamzadeh", 200,20);
